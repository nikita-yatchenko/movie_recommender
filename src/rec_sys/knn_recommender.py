...
class KNNRecommender:
    ...
    def _get_movie_features(self):
        ...
        :return:
            - movie_features
        '''
        movie_svd = TruncatedSVD(n_components=10, random_state=42)
    ...
    def _cosine_similarity(movie_vector, total_movie_features):
        ...
        :return:
            - a sorted dataframe by most similar to least
        '''
    ...
    def make_recommendations(self, movie_name, top_n):
        '''
        Given a movie name - return a list of top n recommendations (closest movies using cosine similarity
        measure)
